...
if __name__ == "__main__":
    ...
    matrix2 = Matrix(rows2)

    # Test inverse calculation
    try:
        inverse_matrix = matrix2.inverse()
        print("Inverse Matrix:")
        print(inverse_matrix)
    except TypeError as e:
        print(e)

    # Test additional power calculation
    try:
    ...
    try:
        result = matrix + matrix2  # Adding matrices of different sizes
        print(result)
    except ValueError as e:
        print(e)

    try:
        result = matrix * matrix2  # Multiplying incompatible matrices
        print(result)
    except ValueError as e:
        print(e)
