...
def main():
    ...
    print("Linked list after inserting elements at the head:")
    print(linked_list)
    ...
    # Printing the linked list
    print("\nLinked list after inserting elements at the tail:")
    print(linked_list)
